...
<div class="main_container">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img id="image_model" src="images/skintone.jpg" alt="Los Angeles" width="1100" height="500">
        ...
        <div class="slider__container slider--one bg__cat--3" style="background:transparent;">
            <div class="slide__container slider__activation__wrap owl-carousel">
                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                    <h3 style="text-align:center; padding-bottom:50px; font-size:50px;" id="t-h1">Trending blog</h3>
                        <div class="row align-items__center">
                        <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img id="image-image" src="images/skintone.jpg" alt="slider images">
                                </div>
                            </div>
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner" id="title-blog">
                                    <h2>Title of blog 1</h2><br>
                                        <!-- <h2>Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                                          Commodi ipsum eius obcaecati architecto veritatis nemo.</h2>
                                           -->
                                        
                                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                                          Commodi ipsum eius obcaecati architecto veritatis nemo.</p>
                                        <div class="cr__btn">
                                            <a href="test.php">View Blog</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                    <h3 style="text-align:center; padding-bottom:50px; font-size:50px;">Trending blog</h3>
                        <div class="row align-items__center">
          ...
          <div class="ft__social__link">
                                      <ul class="social__link">
                                          ...
                                          <li style="background:#f09433;"><a href="#"><i class="icon-social-instagram icons"></i></a></li>
