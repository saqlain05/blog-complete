...
if(isset($_POST['submit'])){
	...
	$res=mysqli_query($con,"select * from blog where name='$name'");
	$check=mysqli_num_rows($res);
	if($check>0){
		if(isset($_GET['id']) && $_GET['id']!=''){
                     ...
                     <div class="card">
                        ...
                        <form method="post" enctype="multipart/form-data" id="get-data-form">
							<div class="card-body card-block">
								...
								<label for="categories" class=" form-control-label">Blogger Text</label>
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Blogger Name</label>
									<input type="text" name="blogername" placeholder="Enter Blogger Name" class="form-control" required value="<?php echo $blogername?>">
								</div>
